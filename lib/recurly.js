(function(){
  ...
  module.exports = function(config){
    ...
    if (!config.API_KEY || !config.SUBDOMAIN) throw new Error('API_KEY and SUBDOMAIN required');
    ...
    this.coupons = {
      ...
      getList: function(callback){
        t.request('/v2/coupons/', 'GET', callback);
      },
      find: function(coupon, callback){
        t.request('/v2/coupons/' + coupon, 'GET', callback);
      }
